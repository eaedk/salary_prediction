...
Let's prediction people salary.
...
Using some variables, we will build a simple Machine Learning model to predict someone's salary.

<!-- Find this work's steps bellow:
- ;
- ;
- . -->
